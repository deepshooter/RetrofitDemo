...
public class NewsListActivityWithCache extends AppCompatActivity implements OnResponseListner {
    ...
    {
        newsListAdapter = new NewsListAdapter(newsList,NewsListActivityWithCache.this);
        vL_anl_newsListView.setLayoutManager(new LinearLayoutManager(NewsListActivityWithCache.this));
    ...
    public void onResponse(Object response, WebServices.ApiType URL, boolean isSucces) {
        ...
        if (URL == WebServices.ApiType.getNewsListCache) {
            if (isSucces) {
                ...
                if(getNewsList.getResponse()!=null)
                {
                    ...
                    {
                        SnackBar.makeText(NewsListActivityWithCache.this, "No News Available", Toast.LENGTH_SHORT).show();
                    }else {
                    ...
                    SnackBar.makeText(NewsListActivityWithCache.this, getString(R.string.no_data_available), Toast.LENGTH_SHORT).show();
                }

            }else {


                SnackBar.makeText(NewsListActivityWithCache.this, getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
            }
    ...
    public class NewsListAdapter extends RecyclerView.Adapter<NewsListAdapter.MyViewHolder>
    {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            Picasso.with(NewsListActivityWithCache.this)
    ...
    private void callNewsListServiceCache()
    {
        WebServices<GetNewsList> newsListWebServices = new WebServices<>(NewsListActivityWithCache.this);
        newsListWebServices.getNewsListCache(WebServices.PublicDevService, WebServices.ApiType.getNewsListCache,"en");
    }
